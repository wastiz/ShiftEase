# Employer Registration Spec

## Purpose

Governs employer account creation. Registered accounts are immediately usable for login — no email verification step is required.
